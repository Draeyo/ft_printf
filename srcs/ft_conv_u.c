...
/*   Updated: 2016/02/17 17:09:12 by vlistrat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_conv_hu(va_list ap, p_list *lst)
{
	...
	if (ft_strstr(lst->modif, "hh"))
	{
		...
		ft_putstr(ft_padding(ft_width(lst, ft_unblen(hhu)),
	...
	else if (ft_strstr(lst->modif, "h"))
	{
		...
		ft_putstr(ft_padding(ft_width(lst, ft_unblen(hu)),
...
static int		ft_conv_lu(va_list ap, p_list *lst)
{
	...
	if (ft_strstr(lst->modif, "ll"))
	{
		...
		ft_putstr(ft_padding(ft_width(lst, ft_ullnblen(llu)),
	...
	else if (ft_strstr(lst->modif, "l"))
	{
		...
		ft_putstr(ft_padding(ft_width(lst, ft_ullnblen(lu)),
...
int				ft_conv_u(va_list ap, p_list *lst)
{
	...
	if (lst->modif == NULL && (lst->conv == 'u' || lst->conv == 'U'))
	{
		...
		ft_putstr(ft_padding(ft_width(lst, ft_unblen(u)),
